        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-green-100 text-lg mt-1">Manage product lucky draws</p>
                </div>
            </div>
            <a href="{{route('admin.productdraws.create')}}" class="inline-flex items-center px-6 py-3 bg-white text-green-600 font-semibold rounded-xl hover:bg-green-50 transition-all duration-200 shadow-lg">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        @else
            <div class="p-8 text-center">
                ...
                <a href="{{route('admin.productdraws.create')}}" class="inline-flex items-center px-6 py-3 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-all duration-200">
                    <i class="fas fa-plus mr-2"></i>
